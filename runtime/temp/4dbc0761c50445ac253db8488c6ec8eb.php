<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"D:\gitee\qp_backstage\public/../application/admin\view\login_log\login_log.html";i:1545024151;s:61:"D:\gitee\qp_backstage\application\admin\view\common\meta.html";i:1545203841;s:63:"D:\gitee\qp_backstage\application\admin\view\common\header.html";i:1546935989;s:61:"D:\gitee\qp_backstage\application\admin\view\common\menu.html";i:1545379393;s:63:"D:\gitee\qp_backstage\application\admin\view\common\footer.html";i:1545201363;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<section class="Hui-article-box">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="<?php echo url('index/index'); ?>">首页</a>
        ...
        用户管理
        <span class="c-gray en">&gt;</span>
        登录日志 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a> </nav>
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="table-responsive">
            <table class="table table-border table-bordered table-bg">
                <form class="form-inline" role="form" method="get" action="<?php echo url('login_log/index'); ?>">
                    <div class="form-group">
                        <span style="color: red;">日志查询</span> 昵称:<input style="width: 120px;" type="text" class="input-text" name="nickname" placeholder="请输入昵称" value="<?php echo !empty($nickname)?$nickname : '';; ?>">
                ...
                <a style="float: right;" class="btn btn-secondary radius" href="<?php echo url('login_log/clearLoginLog'); ?>">清理七天前日志</a>
                <thead>
                <tr>
