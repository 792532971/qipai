<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"D:\gitee\qp_backstage\public/../application/admin\view\user\user_list.html";i:1545297343;s:61:"D:\gitee\qp_backstage\application\admin\view\common\meta.html";i:1545203841;s:63:"D:\gitee\qp_backstage\application\admin\view\common\header.html";i:1546935989;s:61:"D:\gitee\qp_backstage\application\admin\view\common\menu.html";i:1545379393;s:63:"D:\gitee\qp_backstage\application\admin\view\common\footer.html";i:1545201363;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
        ...
        <article class="cl pd-20">
            <form class="form-inline" role="form" method="get" action="<?php echo url('user/user_list'); ?>">
                <div class="form-group">
                     昵称:<input style="width: 120px;" type="text" class="input-text" name="nickname" placeholder="请输入昵称" value="<?php echo !empty($nickname)?$nickname : '';; ?>">
                ...
                <div class="table-responsive">
                    <table style="white-space: nowrap;word-break:keep-all;" class="table table-border table-bordered table-hover table-bg table-sort" id="table">
                        ...
                        <tr class="text-c">
                            ...
                            <td><?php echo $vo['incom']; ?></td>
                            <td><?php echo $vo['create_time']; ?></td>
                            <td><?php echo $vo['active_time']; ?></td>
                            <td><?php echo $vo['status']; ?></td>
                            <td><?php echo $vo['lock']; ?></td>
                            <td>
                                ...
                                <a href="javascript:;" onClick="member_edit('邮件','/admin.php/admin/user/user_displayMail?id=<?php echo $vo['id']; ?>','4','','400')" class="ml-5 btn btn-success-outline radius size-MINI" style="text-decoration:none">邮件</a>
