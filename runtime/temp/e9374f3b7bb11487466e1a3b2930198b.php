<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"D:\gitee\qp_backstage\public/../application/admin\view\admin\loginlog.html";i:1545023604;s:61:"D:\gitee\qp_backstage\application\admin\view\common\meta.html";i:1545203841;s:63:"D:\gitee\qp_backstage\application\admin\view\common\header.html";i:1546935989;s:61:"D:\gitee\qp_backstage\application\admin\view\common\menu.html";i:1545379393;s:63:"D:\gitee\qp_backstage\application\admin\view\common\footer.html";i:1545201363;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
            ...
            <table class="table table-border table-bordered table-bg">
                <form class="form-inline" role="form" method="get" action="<?php echo url('admin/loginlog'); ?>">
                    <div class="form-group">
                        <span style="color: red;">日志查询</span> 昵称:<input style="width: 120px;" type="text" class="input-text" name="username" placeholder="请输入昵称" value="<?php echo !empty($username)?$username : '';; ?>">
                ...
                <a style="float: right;" class="btn btn-success-outline radius" href="" id="clearAdminLog">清理七天前日志</a>
                <thead>
                <tr>
                ...
                <tr class="text-c">
                    ...
                    <td><?php echo $vo['admin']['username']; ?></td>
